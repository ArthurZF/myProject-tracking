<template>
  <div class="form-outs">
    <el-form
      ...
      label-suffix="："
      label-position="left"
      :rules="changeDataRules"
    >
      <el-form-item label="账号" prop="account">
        <el-input
          v-model.trim="userMsg.account"
          placeholder="请输入账号"
          clearable
        ></el-input>
      </el-form-item>
      <el-form-item label="姓" prop="userFirstName">
        <el-input
          v-model.trim="userMsg.userFirstName"
          placeholder="请输入姓"
          clearable
        ></el-input>
      </el-form-item>
      <el-form-item label="名" prop="userLastName">
        <el-input
          v-model.trim="userMsg.userLastName"
          placeholder="请输入名"
          clearable
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="验证码" prop="checkText">
        <el-input
          v-model.trim="userMsg.checkText"
          placeholder="请输入验证码"
          clearable
          class="check-input float-left"
        >
        </el-input>
        <div
          class="check-img float-left flex flex-align-center flex-just-center"
        >
          <!-- {{checkText}} -->
          1234
        </div>
